...
def equals(
    ...
    """判断是否相等"""
    assume(check_value == expect_value, message)
...
def length_equals(
    ...
    assume(len(check_value) == expect_value, message)
...
def length_greater_than(
    ...
    assume(len(str(check_value)) == expect_value, message)
...
def contains(check_value: Any, expect_value: Any, message: Text = ""):
    ...
    assume(expect_value in check_value, message)
...
def contained_by(check_value: Any, expect_value: Any, message: Text = ""):
    ...
    assume(check_value in expect_value, message)
...
def startswith(
    ...
    assume(str(check_value).startswith(str(expect_value)), message)
...
def endswith(
    ...
    assume(str(check_value).endswith(str(expect_value)), message)
